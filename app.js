          ...
          const openAIResponse = await axios({
            ...
            data: {
              ...
              messages: [
                {
                  role: "system",
                  content: `You are an application that receives as input the list of foods detected by Clarifai on a photo. Based on this, you have to create 4 possible dishes, considering only common combinations of the ingredients and avoiding unusual or rare dishes. Each dish should be separated by a ";" and only include the name of the dish (in French) and the estimated number of kilocalories, i.e. the figure followed by "kcal", without any other words or punctuation (except ";"). Also, the number of calories should be adjusted based on the selected portion size (biteSize, smallPlate, mediumPlate, largePlate, fullPlate). The user is aware that the calorie estimate may not be exact. Example output: Poulet rôti, 500 kcal; Spaghetti Bolognaise, 700 kcal; Salade César; 350 kcal`,
                },
                {
                  role: "user",
